...
使用 `create-lithe` cli 创建项目，目前提供了两个模板。

1. [lithe-admin](https://github.com/tenianon/lithe-admin) 默认模板
2. [lithe-admin-lite](https://github.com/tenianon/lithe-admin/tree/lite) 精简模板（只有登录和错误页面）
...
[90m│[39m  [95m● 默认 - Lithe Admin[0m [2m(默认模板)[0m
[90m│[39m  [2m○ 精简 - Lithe Admin Lite[0m
[90m│[39m
...
之后就可以在 `http://localhost:5799` 上访问项目了。
